    ...
    //     }
        ...
        htmlDD += `
            <table>
                ...
                <tr><td>Jml. ingin diinput</td><td>:</td><td><input type='number' name='jml_input[]' value=${jml_selesai-jml_sdh_nota}></td></tr>
        ...
        */
        ...
        htmlSPKItem += `
            <tr class='bb-1px-solid-grey'>
                ...
                <td style='color:green;font-weight:bold;'>${nota_item_av[i].jml_selesai - nota_item_av[i].jml_sdh_nota}<input type='hidden' name='jml_av[]' value='${nota_item_av[i].jml_selesai - nota_item_av[i].jml_sdh_nota}'></td>
